...
class Page_menu_m extends  MY_Model {

protected $_table_name = 'pages_menu';
...
public function get_nested() {
   ...
   $pages = $this->db->get('pages_menu')->result_array();
   $array = array();
...
public function get_with_parents($id = NULL, $single = FALSE)  {
	//
	$this->db->select('pages_menu.*, p.slug as parent_slug, p.title as parent_title');
	$this->db->join('pages_menu as p', 'pages_menu.parent_id=p.id', 'left');
