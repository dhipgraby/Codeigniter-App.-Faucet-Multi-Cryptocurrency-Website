...
<br>
  ...
  <p><img src="<?php echo base_url() ?>images/btclogo.png" style="height: 28px; width: 28px"> BTC:  <?php echo form_checkbox('coin','',TRUE, 'type="checkbox" class="form-check-input" id="btc"'); ?>
...
<div class="container sm-12" align="center">
  <div class="row">
    ...
    <div class="col-sm" align="center">
      ...
      <br>
      <small>Win = <b id="profit">0</b> </small></div>
...
<span name="autobet_item" class="auto_item">
  <b>Total Profit :</b> <?php echo form_input('game_profit', '0', 'class="form-control" style="aling-content:center;" id="game_profit" onchange="noteLimit(this, 6)"'); ?>
</span>
