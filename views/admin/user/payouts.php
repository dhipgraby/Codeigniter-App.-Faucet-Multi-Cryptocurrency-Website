...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    ...
    <div class="dropdown-menu">
      ...
      <a name="option" id="address" class="dropdown-item" href="#">Withdraw address</a>
...
<br>
<span id="deposit_table"> <?php $this->load->view('admin/tables/withdraw'); ?></span>
...
var option = $('#current_option').attr('name');
			...
			url: "<?php echo base_url(); ?>admin/withdraw/table",
			type: "POST",
