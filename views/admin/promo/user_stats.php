...
<h3>Promoter lvl : <?php echo $promoter_lvl; ?></h3>
<br>
...
<input id="myInput" class="form-control" type="text" name="refurl" value="<?php echo base_url() ?>main?ref=<?php echo $promo_id; ?>" readonly>
...
<tr>
  <td><?php echo $today_payout; ?></td>
    <td><?php echo $weekly_payout; ?></td>
      <td><?php echo $monthly_payout; ?></td>
...
<?php echo new_button('Today','today','dark submenu','name="graphic"') ?>  
<?php echo new_button('Last 7 days','week','dark submenu mr-1 ml-1','name="graphic"') ?>
<?php echo new_button('Last 30 days','month','dark submenu','name="graphic"') ?>
...
var view = $(this).attr('id');
    ...
    $.ajax({
      ...
      url: "<?php echo base_url(); ?>admin/promoters/change_view/<?php echo $promo_id; ?>",
      type: "POST",
      data: { view : view, },
...
$.ajax({
  ...
  event.preventDefault();
      ...
      type: "POST",
      data: { password : password , pincode : pincode , email_code : email_code, amount : amount, currency : currency, },
